...
If the adversary has [[atlas/techniques/ai-model-access/ai-model-inference-api-access|AI Model Inference API Access]], they may use [[atlas/techniques/ai-attack-staging/verify-attack|Verify Attack]] to confirm the attack is working and incorporate that information into their training process.
