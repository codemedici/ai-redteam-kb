...
Depending on the adversary's knowledge of and access to the target model, the adversary may use different classes of algorithms to develop the adversarial example such as [[white-box-optimization|White-Box Optimization]], [[black-box-optimization|Black-Box Optimization]], [[black-box-transfer|Black-Box Transfer]], or [[manual-modification|Manual Modification]].

The adversary may [[verify-attack|Verify Attack]] their approach works if they have white-box or inference API access to the model.
...
An adversary may optimize adversarial examples for [[evade-ai-model|Evade AI Model]], or to [[erode-ai-model-integrity|Erode AI Model Integrity]].
...
- [[white-box-optimization|AML.T0043.000: White-Box Optimization]]
- [[black-box-optimization|AML.T0043.001: Black-Box Optimization]]
- [[black-box-transfer|AML.T0043.002: Black-Box Transfer]]
- [[manual-modification|AML.T0043.003: Manual Modification]]
- [[insert-backdoor-trigger|AML.T0043.004: Insert Backdoor Trigger]]
