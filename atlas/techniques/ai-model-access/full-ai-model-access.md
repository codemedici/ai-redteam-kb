...
They may exfiltrate the model to [[craft-adversarial-data|Craft Adversarial Data]] and [[verify-attack|Verify Attack]] in an offline where it is hard to detect their behavior.
