...
Adversaries can [[craft-adversarial-data|Craft Adversarial Data]] that prevents an AI model from correctly identifying the contents of the data or [[generate-deepfakes|Generate Deepfakes]] that fools an AI model expecting authentic data.
