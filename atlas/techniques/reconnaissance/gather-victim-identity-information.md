...
Adversaries may gather this information in various ways, such as direct elicitation, [[search-victim-owned-websites|Search Victim-Owned Websites]], or via leaked information on the black market.

Adversaries may use the gathered victim data to Create Deepfakes and impersonate them in a convincing manner. This may create opportunities for adversaries to [[establish-accounts|Establish Accounts]] under the impersonated identity, or allow them to perform convincing [[phishing|Phishing]] attacks.
