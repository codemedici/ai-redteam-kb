...
**General category:**
- [[attacks/adversarial-examples]] — Digital perturbation-based evasion

**Similar physical attacks:**
- [[attacks/3d-adversarial-objects]] — Entire objects crafted to fool AI

**Mitigated by:**
- [[defenses/input-preprocessing]] — JPEG compression, Gaussian blur
- [[defenses/adversarial-training]] — Train with patched examples
- [[defenses/anomaly-detection]] — Flag unusual visual patterns
- [[defenses/certified-defenses]] — Provable robustness bounds
