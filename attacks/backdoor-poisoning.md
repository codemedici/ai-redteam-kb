...
**Variant of:**
- [[attacks/data-poisoning]] — General category of training data manipulation

**Related techniques:**
- [[attacks/clean-label-attacks]] — Can combine with backdoors (clean-label backdoor)
- [[attacks/model-tampering]] — Alternative approach via direct model modification

**Mitigated by:**
- [[defenses/anomaly-detection]] — Flag suspicious training samples
- [[defenses/adversarial-training]] — Include backdoored examples in training
- [[defenses/activation-clustering]] — Detect abnormal internal activations
- [[defenses/spectral-signature]] — Identify deviations in frequency domain
- [[defenses/roni-defense]] — Reject samples with negative performance impact
