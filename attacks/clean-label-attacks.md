...
Clean-label poisoning attacks are a sophisticated form of [[attacks/data-poisoning]] where the attacker subtly manipulates training data **without changing the labels**. The poisoned data appears benign and is correctly labeled, but is strategically altered to cause the model to misbehave in specific, attacker-desired ways.
...
See [[attacks/backdoor-poisoning]] for trigger mechanics.
...
**Category:**
- [[attacks/data-poisoning]] — Parent attack class

**Can combine with:**
- [[attacks/backdoor-poisoning]] — Clean-label backdoors

**Mitigated by:**
- [[defenses/mlops-security]] — Data lineage and versioning
- [[defenses/adversarial-training]] — Include clean-label examples
- [[defenses/activation-clustering]] — Detect abnormal activations
- [[defenses/spectral-signature]] — Frequency domain analysis
