...
**Related Attacks:** [[attacks/prompt-injection|Prompt Injection]], [[attacks/system-prompt-leakage|System Prompt Leakage]], [[attacks/agent-goal-hijack|Agent Goal Hijacking]]
...
**Technical:**
- [[defenses/llm-operational-resilience-monitoring|LLM Detection Tools]] - Identify AI-generated text (though arms race ongoing)
...
**Organizational:**
- [[defenses/approval-workflow-patterns|Multi-Party Approval]] for financial transactions
...
**Related Attacks:**
- [[attacks/prompt-injection|Prompt Injection]] - Manipulate LLM-powered assistants
- [[attacks/agent-goal-hijack|Agent Goal Hijacking]] - Abuse autonomous agents
- [[attacks/system-prompt-leakage|System Prompt Leakage]] - Extract internal instructions

**Defenses:**
- [[defenses/input-validation-patterns|Input Validation]] - Detect anomalous message patterns
- [[defenses/dual-llm-judge-pattern|Dual LLM Judge]] - Use AI to detect AI-generated content
- [[defenses/approval-workflow-patterns|Approval Workflows]] - Multi-party authorization
