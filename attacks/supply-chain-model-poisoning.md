...
**Scenario**: Attacker trains a model with backdoors using techniques from [[attacks/backdoor-poisoning|backdoor poisoning]] or [[attacks/clean-label-attacks|clean-label attacks]], then distributes it as a "pre-trained" base model.
...
- **Similar Attacks**: [[attacks/data-poisoning-attacks]], [[attacks/backdoor-poisoning]], [[attacks/trojan-injection]]
- **Defenses**: [[playbooks/ai-supply-chain-security]], [[defenses/content-signing-and-provenance]]
