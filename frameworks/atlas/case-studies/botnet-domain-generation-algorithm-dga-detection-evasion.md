...
1. [Yu, Bin, Jie Pan, Jiaming Hu, Anderson Nascimento, and Martine De Cock.  "Character level based detection of DGA domain names." In 2018 International Joint Conference on Neural Networks (IJCNN), pp. 1-8. IEEE, 2018.](http://faculty.washington.edu/mdecock/papers/byu2018a.pdf)
2. [Degas source code](https://github.com/matthoffman/degas)
