...
- [[frameworks/atlas/techniques/collection/data-from-ai-services|AML.T0085: Data from AI Services]] — Configuring AI Agent tools with access controls inherited from the user or the AI Agent invoking the tool can limit adversary's access to sensitive data.
