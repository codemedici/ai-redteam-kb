...
- [[frameworks/atlas/techniques/persistence/manipulate-ai-model|AML.T0018: Manipulate AI Model]] — Code signing provides a guarantee that the model has not been manipulated after signing took place.
