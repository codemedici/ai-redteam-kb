...
- [[frameworks/atlas/techniques/execution/llm-prompt-injection/LLM-direct-prompt-injection|AML.T0051: LLM Prompt Injection]] — Guardrails can prevent harmful inputs that can lead to prompt injection.
...
- [[frameworks/atlas/techniques/initial-access/ai-supply-chain-compromise/supply-chain-compromise-data|AML.T0010: AI Supply Chain Compromise]] — Guardrails can detect harmful code in model outputs.
