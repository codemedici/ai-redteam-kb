...
- [[frameworks/atlas/techniques/collection/data-from-ai-services|AML.T0085: Data from AI Services]] — Segmentation can prevent adversaries from utilizing tools in an agentic workflow to collect sensitive data from AI services.
