...
> **Sub-Technique of:** [[frameworks/atlas/techniques/ai-attack-staging/craft-adversarial-data|AML.T0043: Craft Adversarial Data]]

The adversary may add a perceptual trigger into inference data.
The trigger may be imperceptible or non-obvious to humans.
This technique is used in conjunction with [[frameworks/atlas/techniques/persistence/manipulate-AI-model-poison|Poison AI Model]] and allows the adversary to produce their desired effect in the target model.
...
- **Parent Technique:** [[frameworks/atlas/techniques/ai-attack-staging/craft-adversarial-data|AML.T0043: Craft Adversarial Data]]
