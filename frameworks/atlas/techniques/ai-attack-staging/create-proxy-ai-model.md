...
- [[frameworks/atlas/techniques/ai-attack-staging/create-proxy-train-via-gathered-artifacts|AML.T0005.000: Train Proxy via Gathered AI Artifacts]]
- [[frameworks/atlas/techniques/ai-attack-staging/create-proxy-train-via-replication|AML.T0005.001: Train Proxy via Replication]]
- [[frameworks/atlas/techniques/ai-attack-staging/create-proxy-use-pre-trained-model|AML.T0005.002: Use Pre-Trained Model]]
