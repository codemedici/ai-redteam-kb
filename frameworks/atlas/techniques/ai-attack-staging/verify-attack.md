...
The adversary may verify their attack digitally, then deploy it in the [[frameworks/atlas/techniques/ai-model-access/physical-environment-access|Physical Environment Access]] at a later time.
