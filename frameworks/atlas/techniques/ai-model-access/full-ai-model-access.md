...
They may exfiltrate the model to [[frameworks/atlas/techniques/ai-attack-staging/craft-adversarial-data|Craft Adversarial Data]] and [[frameworks/atlas/techniques/ai-attack-staging/verify-attack|Verify Attack]] in an offline where it is hard to detect their behavior.
