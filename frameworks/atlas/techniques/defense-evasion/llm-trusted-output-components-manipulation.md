...
The LLM may be instructed to tailor its language to appear more trustworthy to the user or attempt to manipulate the user to take certain actions. Other response components that could be manipulated include links, recommended follow-up actions, retrieved document metadata, and [[frameworks/atlas/techniques/defense-evasion/LLM-trusted-output-manipulation-citations|Citations]].
...
- [[frameworks/atlas/tactics/defense-evasion|AML.TA0007: Defense Evasion]]



## Sub-Techniques (1)

- [[frameworks/atlas/techniques/defense-evasion/LLM-trusted-output-manipulation-citations|AML.T0067.000: Citations]]
