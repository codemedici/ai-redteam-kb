...
> **Sub-Technique of:** [[frameworks/atlas/techniques/execution/user-execution|AML.T0011: User Execution]]

Adversaries may develop malicious software packages that when imported by a user have a deleterious effect.
Malicious packages may behave as expected to the user. They may be introduced via [[frameworks/atlas/techniques/initial-access/ai-supply-chain-compromise|AI Supply Chain Compromise]]. They may not present as obviously malicious to the user and may appear to be useful for an AI-related task.
...
- **Parent Technique:** [[frameworks/atlas/techniques/execution/user-execution|AML.T0011: User Execution]]
