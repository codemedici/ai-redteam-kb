...
> **Sub-Technique of:** [[frameworks/atlas/techniques/exfiltration/exfiltration-via-ai-inference-api|AML.T0024: Exfiltration via AI Inference API]]
...
Some strategies make use of a shadow model that could be obtained via [[frameworks/atlas/techniques/ai-attack-staging/create-proxy-train-via-replication|Train Proxy via Replication]], others use statistics of model prediction scores.
...
- **Parent Technique:** [[frameworks/atlas/techniques/exfiltration/exfiltration-via-ai-inference-api|AML.T0024: Exfiltration via AI Inference API]]
