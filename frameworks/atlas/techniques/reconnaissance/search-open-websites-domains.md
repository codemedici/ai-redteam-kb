...
Adversaries may find the information they seek to gather via search engines. They can use precise search queries to identify software platforms or services used by the victim to use in targeting. This may be followed by [[frameworks/atlas/techniques/initial-access/exploit-public-facing-application|Exploit Public-Facing Application]] or [[frameworks/atlas/techniques/initial-access/prompt-infiltration-via-public-facing-application|Prompt Infiltration via Public-Facing Application]].
