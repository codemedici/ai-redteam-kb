...
- **[[engagements|View All Engagements]]** - Specific engagement offerings with methodology application examples
...
- [[trust-boundaries|Trust Boundaries Overview]] - The four-boundary model underlying threat modeling
- [[issues|Model Boundary Issues]] - Jailbreaks, prompt injection, training data extraction
- [[issues|Data/Knowledge Boundary Issues]] - RAG poisoning, embedding attacks
- [[application-agent-runtime|Application/Agent Boundary Issues]] - Tool misuse, goal hijacking
- [[deployment-governance|Deployment/Governance Issues]] - Access control, secrets exposure
