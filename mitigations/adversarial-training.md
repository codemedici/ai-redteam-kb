...
- [[mitigations/anomaly-detection]] — Detect poisoned training data
- [[mitigations/mlops-security]] — Data lineage and versioning
- [[mitigations/input-validation]] — Runtime input sanitization
- [[mitigations/model-ensembles]] — Multiple models for robustness
...
**Defends against:**
- [[techniques/data-poisoning]] — Training-time manipulation
- [[techniques/backdoor-poisoning]] — Trigger-based attacks
- [[techniques/adversarial-examples]] — Inference-time perturbations
- [[techniques/evasion]] — General evasion techniques

**Complements:**
- [[mitigations/input-preprocessing]] — Runtime sanitization
