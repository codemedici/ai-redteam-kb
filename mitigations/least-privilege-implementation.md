...
- [[techniques/tool-privilege-escalation|Tool Privilege Escalation Issue]] - Detailed attack vectors and mitigations
- [[techniques/unsafe-tool-invocation|Unsafe Tool Invocation Issue]] - Related attack patterns
- [[techniques/agent-goal-hijack|Agent Goal Hijacking Issue]] - How privilege escalation enables goal hijacking
