...
### [[ai-threat-exposure-review|AI Threat Exposure Review]]
...
### [[llm-application-red-team|LLM Application Red Team]]
...
### [[rag-retrieval-assessment|RAG & Retrieval Attack Assessment]]
...
### [[ai-model-risk-assessment|AI Model Risk Assessment]]
...
### [[ai-supply-chain-security|AI Supply Chain Security Testing]]
...
### [[agentic-workflow-assessment|Agentic Workflow Assessment]]
...
### [[evaluation-pipeline-review|AI Evaluation Pipeline Review]]
...
- **Comprehensive Coverage**: [[ai-threat-exposure-review|AI Threat Exposure Review]] covers all trust boundaries
- **Focused Testing**: [[llm-application-red-team|LLM Application Red Team]] for application-layer attacks, [[rag-retrieval-assessment|RAG Assessment]] for retrieval security
- **Risk Management**: [[ai-model-risk-assessment|AI Model Risk Assessment]] for holistic risk review, [[evaluation-pipeline-review|Evaluation Pipeline Review]] for process improvement
- **Specialized Systems**: [[ai-supply-chain-security|Supply Chain Security]] for pipeline security, [[agentic-workflow-assessment|Agentic Assessment]] for autonomous agents

See [[engagement-type-differences|Engagement Type Differences]] for detailed comparison and overlap guidance.
