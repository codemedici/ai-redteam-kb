...
- [[techniques/adversarial-patches]] — Localized, visible perturbations for physical attacks

**NLP variants:**
- [[techniques/textattack-evasion]] — Text-based adversarial examples

**Training-time equivalent:**
- [[techniques/data-poisoning]] — Manipulate training data instead of inference inputs

**Mitigated by:**
- [[mitigations/adversarial-training]] — Train with adversarial examples
- [[mitigations/input-preprocessing]] — Sanitize inputs (JPEG compression, quantization)
- [[mitigations/model-ensembles]] — Multiple models for redundancy
- [[mitigations/certified-defenses]] — Provable robustness guarantees
...
- **Mitigated by**: [[mitigations/adversarial-training]], [[mitigations/adversarial-robustness-controls]], [[mitigations/input-validation-transformation]], [[mitigations/anomaly-detection-architecture]]
