...
See [[mitigations/|Application/Agent Runtime Controls]] for architectural guidance on implementing these mitigations.
...
- **Mitigated by**: [[mitigations/instruction-hierarchy-architecture]], [[mitigations/least-privilege-implementation]], [[mitigations/approval-workflow-patterns]], [[mitigations/anomaly-detection-architecture]], [[mitigations/kill-switch-and-session-termination]]
- **Enables**: [[techniques/tool-privilege-escalation]], [[techniques/unsafe-tool-invocation]]
- **Enabled by**: [[techniques/prompt-injection]]
- **ATLAS**: AML.T0051
