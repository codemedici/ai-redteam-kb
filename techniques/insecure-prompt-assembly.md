...
- **Mitigated by**: [[mitigations/input-validation-patterns]], [[mitigations/instruction-hierarchy-architecture]], [[mitigations/output-filtering-and-sanitization]]
- **Enables**: [[techniques/prompt-injection]]
- **ATLAS**: AML.T0051
