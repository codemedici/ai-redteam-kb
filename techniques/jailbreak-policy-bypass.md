...
**TODO:** Complete summary - describe how attackers bypass safety controls to generate prohibited content.

## Threat Scenario

**TODO:** Describe concrete jailbreak scenario.
...
**Automated Testing:**
- **TODO:** Tool recommendations (e.g., garak, PyRIT)
...
- **Mitigated by**: [[mitigations/instruction-hierarchy-architecture]], [[mitigations/input-validation-patterns]], [[mitigations/dual-llm-judge-pattern]], [[mitigations/output-filtering-and-sanitization]], [[mitigations/anomaly-detection-architecture]]
- **Enables**: [[techniques/system-prompt-leakage]], [[techniques/sensitive-info-disclosure]], [[techniques/training-data-memorization]]
