...
**Related Attacks:** [[techniques/data-poisoning-attacks|Data Poisoning]], [[techniques/backdoor-poisoning|Backdoor Poisoning]], [[techniques/third-party-model-risks|Third-Party Model Risks]]
...
### Code Analysis
- [[mitigations/input-validation-transformation|Static Analysis Tools]] - SonarQube, Semgrep, CodeQL to catch common patterns
...
**Related Attacks:**
- [[techniques/data-poisoning-attacks|Data Poisoning]] - Manipulate training data
- [[techniques/backdoor-poisoning|Backdoor Poisoning]] - Inject malicious behavior
- [[techniques/third-party-model-risks|Third-Party Model Risks]] - Untrusted model sources

**Defenses:**
- [[mitigations/input-validation-transformation|Input Validation]] - Sanitize code inputs
- [[mitigations/llm-development-lifecycle-security|LLM Development Lifecycle Security]] - Secure SDLC for AI
