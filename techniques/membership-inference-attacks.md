...
- **Attribute inference:** Inferring other sensitive attributes (see [[techniques/privacy-attacks-beyond-membership-inference|Privacy Attacks Beyond MIA]])
- **Targeted data poisoning:** Using membership knowledge to craft more effective [[techniques/data-poisoning-attacks|poisoning attacks]]
...
See [[techniques/privacy-attacks-beyond-membership-inference|Privacy Attacks Beyond MIA]] for details.
...
- **Mitigated by**: [[mitigations/adversarial-training]], [[mitigations/rate-limiting-and-throttling]]
- **Enables**: [[techniques/privacy-attacks-beyond-membership-inference]]
