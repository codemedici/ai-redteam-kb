...
[[techniques/membership-inference-attacks|Membership Inference Attacks]] determine if specific data was used in training—but that's often just scratching the surface of AI privacy risks. The more damaging question is: **what else can they learn?**
...
3. **White-Box Analysis**
   - With access to model parameters (see [[techniques/model-extraction|Model Extraction]])
...
- **Combine Attacks:** Use [[techniques/membership-inference-attacks|membership inference]] first to identify potentially sensitive/memorized data points before attempting more costly inversion attack
...
- **Mitigated by**: [[mitigations/adversarial-training]], [[mitigations/rate-limiting-and-throttling]], [[mitigations/access-segmentation-and-rbac]]
- **ATLAS**: [[frameworks/atlas/techniques/exfiltration/exfiltration-via-cyber-means|AML.T0025]], AML.T0024
