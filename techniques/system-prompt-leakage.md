...
- **Blueprint of all allowed tools** → perfect reconnaissance for [[techniques/agentic-ai-security-risks-owasp-aivss|Agentic AI Tool Misuse]] (OWASP AIVSS Risk 1)
...
- **Mitigated by**: [[mitigations/instruction-hierarchy-architecture]], [[mitigations/output-filtering-and-sanitization]], [[mitigations/input-validation-patterns]]
- **Enabled by**: [[techniques/prompt-injection]], [[techniques/jailbreak-policy-bypass]]
- **Enables**: [[techniques/insecure-prompt-assembly]]
- **ATLAS**: AML.T0051
