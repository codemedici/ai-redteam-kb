...
- [x] [[ai-threat-exposure-review|AI Threat Exposure Review]] - Comprehensive assessment across all boundaries
- [x] [[llm-application-red-team|LLM Application Red Team]] - Primary focus on prompt injection campaigns (direct/indirect)
- [x] Agentic Workflow Assessment - Agent-specific injection testing (detail page pending)
- [x] RAG & Retrieval Assessment - Indirect injection via RAG documents (detail page pending)
- [x] Evaluation & Guardrail Validation - Prompt injection resistance testing (detail page pending)
